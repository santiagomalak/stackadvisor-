...
const FAQS = [
  {
    q: '¿En cuánto tiempo recibo el Blueprint?',
    a: 'Inmediatamente después del pago. Respondés el cuestionario extendido y el Blueprint se genera al instante con IA. La consulta 1:1 la coordinás por email en las 48hs siguientes.',
  },
  {
    q: '¿Para qué tipo de proyectos sirve?',
    a: 'Para cualquier proyecto web, mobile o SaaS. El cuestionario extendido captura todos los detalles de tu proyecto específico para que el Blueprint sea 100% personalizado.',
  },
  {
    q: '¿Necesito saber programar para aprovecharlo?',
    a: 'No necesariamente. Si sos no-técnico, el Blueprint te ayuda a entender qué pedirle a un desarrollador y a evaluar presupuestos. Si sos dev, te ahorra semanas de decisiones.',
  },
  {
    q: '¿Qué pasa si no quedé conforme?',
    a: 'Garantía de 7 días. Si el Blueprint no te sirvió, te devolvemos el dinero sin preguntas.',
  },
];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-blue-950 text-white py-20">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl opacity-85 max-w-2xl mx-auto mb-8 leading-relaxed">
          ...
          <div className="bg-white/10 border border-white/20 rounded-2xl p-8 max-w-sm mx-auto">
            ...
            <div className="text-white/60 text-sm mb-6">USD · pago único · acceso permanente</div>
            <button
              onClick={handleBuy}
              disabled={loading}
              className="w-full bg-accent hover:bg-green-500 disabled:bg-green-800 text-white font-bold py-4 px-8 rounded-xl text-lg transition-all transform hover:scale-105 shadow-xl disabled:scale-100 disabled:cursor-not-allowed"
            >
              {loading ? (
            ...
            <p className="text-white/50 text-xs mt-3">🔒 Pago seguro con Stripe · Garantía 7 días</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-gray-500 dark:text-slate-400 text-center mb-12 max-w-xl mx-auto">
            No es un PDF genérico. Es un documento construido específicamente para tu proyecto,
            tu stack y tu nivel de experiencia.
          </p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 dark:bg-slate-700">
                  ...
                  <th className="text-center py-4 px-4 text-primary font-bold">Blueprint $49</th>
                </tr>
              </thead>
                ...
                {[
                  ...
                  <tr key={feature as string} className="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                    ...
                    <td className="py-3 px-4 text-center">
                      {free ? <span className="text-accent font-bold">✓</span> : <span className="text-gray-300 dark:text-slate-600">—</span>}
                    </td>
                    <td className="py-3 px-4 text-center">
                      {paid ? <span className="text-accent font-bold">✓</span> : <span className="text-gray-300 dark:text-slate-600">—</span>}
                    </td>
                  </tr>
                ))}
              </tbody>
      ...
      <section className="py-16 bg-gradient-to-br from-primary to-blue-700">
        <div className="container mx-auto px-4 max-w-xl text-center text-white">
          ...
          <p className="opacity-85 mb-8">
            En menos de 10 minutos tenés tu Blueprint completo listo para usar.
          </p>
          <button
            onClick={handleBuy}
            disabled={loading}
            className="bg-white text-primary font-bold py-4 px-10 rounded-xl text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl disabled:scale-100 disabled:cursor-not-allowed"
          >
            {loading ? 'Redirigiendo...' : 'Obtener mi Blueprint por $49 →'}
          </button>
          <p className="text-white/50 text-xs mt-3">🔒 Pago seguro con Stripe · Garantía 7 días</p>
        </div>
      </section>
